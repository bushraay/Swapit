...
import { auth, database } from "C:/Users/DELL/Documents/GitHub/fyp/MyNewProject/react-native-chat/config/firebase"; 
...
export default function CreateAccountPage({ navigation }) {
  ...
  const checkEmailExists = async (email) => {
    try {
      // Check MongoDB
      const mongoResponse = await axios.post('http://192.168.0.109:5000/check-email', { 
        email 
      });
